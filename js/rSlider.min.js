!function() {
    ...
    var t = function(t) {
        ...
        for (var i in this.conf)
            t.hasOwnProperty(i) && (this.conf[i] = t[i]);
        this.init()
    };
    ...
    t.prototype.setInitialValues = function() {
        ...
        this.conf.set && this.conf.set.length && n(this.conf)) {
            var t = this.conf.set;
            this.conf.range ? (this.values.start = this.conf.values.indexOf(t[0]),
            this.values.end = this.conf.set[1] ? this.conf.values.indexOf(t[1]) : null) : this.values.end = this.conf.values.indexOf(t[0])
        }
    ...
    t.prototype.addEvents = function() {
        ...
        return window.addEventListener("resize", this.onResize.bind(this)),
        this.setValues()
    }
    ,
    t.prototype.drag = function(t) {
        ...
        !this.conf.disabled) {
            ...
            return "left" === i && (this.activePointer = this.pointerL),
    ...
    t.prototype.move = function(t) {
        if (this.activePointer && !this.conf.disabled) {
            ...
            return (i = Math.round(i / this.step)) <= 0 && (i = 0),
            i > this.conf.values.length - 1 && (i = this.conf.values.length - 1),
            this.conf.range ? (this.activePointer === this.pointerL && (this.values.start = i),
            this.activePointer === this.pointerR && (this.values.end = i)) : this.values.end = i,
            this.setValues()
        }
    }
    ,
    ...
    t.prototype.onClickPiece = function(t) {
        if (!this.conf.disabled) {
            ...
            return i > this.conf.values.length - 1 && (i = this.conf.values.length - 1),
            i < 0 && (i = 0),
    ...
    var i = function(t, i, e) {
      ...
      , s = function(t) {
        ...
        return i.indexOf(t.values.max) < 0 && i.push(t.values.max),
        i
    }
      , n = function(t) {
