...
function addUseCount() {
    ...
    $.ajax({
        url: 'https://hkitguy.info/TaikoScore/useCount/add',
        data: {
            taiko_ban: getToken(),
            device: device
        },
...
function resetTabList() {
    $.ajax({
        url: 'https://hkitguy.info/TaikoScore/useCount/resetTab',
        data: {
            taiko_ban: getToken(),
            token: getCookie("_token_v2")
        },
        type: 'POST',
        dataType: "json",
        // async: true,
...
function changeSongListFunction(genre) {
    // console.log("clicked");
    $.ajax({
        url: 'https://hkitguy.info/TaikoScore/useCount/test',
        data: {
            taiko_ban: getToken(),
            genre: genre,
            token: getCookie("_token_v2")
...
function addFriendTagField() {
    let appendHtml = '<div class="friendTagArea"><span>標籤：</span><input class="friendTagArea" value=""/><button>確定</button>';
